...
declare module '$env/static/private' {
	...
	export const VUE_APP_SHASTA_PRIVATE_KEY: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VUE_APP_SHASTA_PRIVATE_KEY: string;
		WINDIR: string;
